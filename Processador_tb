...
begin
    ...
    begin
        ...
        opcode_in_tb <= OPCODE_MOV_IMM; data_A_in_tb <= x"10"; data_B_in_tb <= x"00"; wait for CLK_PERIOD*2;
        -- Escrever 0x05 no Registrador 1
        opcode_in_tb <= OPCODE_MOV_IMM; data_A_in_tb <= x"05"; data_B_in_tb <= x"01"; wait for CLK_PERIOD*2;
        -- Escrever 0x03 no Registrador 2
        opcode_in_tb <= OPCODE_MOV_IMM; data_A_in_tb <= x"03"; data_B_in_tb <= x"02"; wait for CLK_PERIOD*2;
        -- Escrever 0x0F no Registrador 3
        opcode_in_tb <= OPCODE_MOV_IMM; data_A_in_tb <= x"0F"; data_B_in_tb <= x"03"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_ADD_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"01"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_ADD_IMM; data_A_in_tb <= x"00"; data_B_in_tb <= x"0A"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_SUB_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"01"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_MUL_REG; data_A_in_tb <= x"01"; data_B_in_tb <= x"02"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_DIV_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"02"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_MOD_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"02"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_CMP_REG; data_A_in_tb <= x"03"; data_B_in_tb <= x"01"; wait for CLK_PERIOD*2;
        -- Resultado é 0x01 e Cout é '1' (GT)
        assert (ula_result_out_tb = x"01" and ula_cout_out_tb = '1' and ula_zero_flag_out_tb = '0') report "Test CMP_REG (GT) Failed" severity error;

        -- 8. Teste CMP_REG (Reg 1 > Reg 3 ? 0x05 > 0x0F -> False)
        report "--- Teste CMP_REG (Reg 1 > Reg 3 -> False) ---" severity note;
        opcode_in_tb <= OPCODE_CMP_REG; data_A_in_tb <= x"01"; data_B_in_tb <= x"03"; wait for CLK_PERIOD*2;
        -- Resultado é 0x00 e Cout é '0'
        assert (ula_result_out_tb = x"00" and ula_cout_out_tb = '0' and ula_zero_flag_out_tb = '0') report "Test CMP_REG (LT) Failed" severity error;

        -- 9. Teste CMP_REG (Reg 1 > Reg 1 ? 0x05 > 0x05 -> Equal)
        report "--- Teste CMP_REG (Reg 1 > Reg 1 -> Equal) ---" severity note;
        opcode_in_tb <= OPCODE_CMP_REG; data_A_in_tb <= x"01"; data_B_in_tb <= x"01"; wait for CLK_PERIOD*2;
        ...
        report "--- Teste AND_REG (Reg 0 AND Reg 3 = 0x02) ---" severity note;
        opcode_in_tb <= OPCODE_AND_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"03"; wait for CLK_PERIOD*2;
        ...
        opcode_in_tb <= OPCODE_OR_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"03"; wait for CLK_PERIOD*2;
        ...
        report "--- Teste XOR_REG (Reg 0 XOR Reg 3 = 0x0D) ---" severity note;
        opcode_in_tb <= OPCODE_XOR_REG; data_A_in_tb <= x"00"; data_B_in_tb <= x"03"; wait for CLK_PERIOD*2;
        assert (ula_result_out_tb = x"0D") report "Test XOR_REG Failed" severity error;
        ...
        opcode_in_tb <= OPCODE_NOT_REG; data_A_in_tb <= x"03"; data_B_in_tb <= x"00"; wait for CLK_PERIOD*2;
